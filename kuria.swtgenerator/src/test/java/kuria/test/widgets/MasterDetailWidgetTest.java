 ...
 *
 */
public class MasterDetailWidgetTest {

	public static void main(String[] args) {
		new MasterDetailWidgetTest().run();
	}
    ...
    private void init(Shell shell) {
	    ...
	    MasterDetailWidget<Person> mdw = new MasterDetailWidget<Person>(shell, SWT.NONE, fac.getBindingContainer(), Person.class);
