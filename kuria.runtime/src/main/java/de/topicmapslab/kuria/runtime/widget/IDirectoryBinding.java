 ...
 * absolute path to a directory and provide a way to edit this path.
 *   
 * This could be done via entering the text into a text field or choose
 * a new directory via a standard dialog.
 * 
 * @author Hannes Niederhausen
 *
 */
public interface IDirectoryBinding extends IPropertyBinding {
